...
<div class="">
    <h4 class="title-normal main-title">Get in Touch ✨</h4>
    <p class="title-desc">I’m always open to collaborate on a project or hear about an opportunity!</p>
</div>
<div class="contact-wrapper">
<div class="contact-list-container">
    <h6 class="title-medium">WANT TO CALL ME?</h6>
    <h4 class="title-medium font-22 contact-link">Schedule a call with me</h4>
</div>
<div class="contact-list-container">
...
<input type="mail" placeholder="Email" class="input-field">
<textarea placeholder="Type your message" class="input-field text-area"/>
<button class="btn send-msg">Send Message</button>
</div>
</div>
<div class="bottom-section">
<Card v-for="(item, i) in BottomCard" :key="i" :className="'bottom-card'" :arrow="true">
